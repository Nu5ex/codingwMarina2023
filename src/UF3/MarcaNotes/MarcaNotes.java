...
public class MarcaNotes {
    //la paraula fi serveix com a marca de final de fitxer
    public static final String MARCA_FI = "fi";
    public static void main (String[] args) {
        MarcaNotes programa = new MarcaNotes();
        programa.inici();
    }
    public void inici() {
        try {
            File f = new File("C:\\Users\\Pablo\\Documents\\DAM1\\MP3\\program\\codingwMarina2023\\src\\UF3\\MarcaNotes\\NotesMarca.txt");
